...
const API_KEY = "$2a$10$TU_API_KEY_AQUI"; // Asegúrate de poner tu API Key real de JSONBin aquí

let products = [];
let cart = [];
let currentFilter = 'todos';

// 1. CARGAR PRODUCTOS DESDE LA NUBE
...
// 2. GUARDAR PRODUCTOS EN LA NUBE
...
function renderAdminProducts() {
    ...
    list.innerHTML = products.map(p => `
        <div class="flex justify-between items-center bg-white p-3 rounded-xl border border-amber-200 shadow-sm mb-2">
...
function editProduct(id) {
    ...
    let titleEl = document.getElementById('admin-form-title');
...
function resetAdminForm() {
    ...
    let titleEl = document.getElementById('admin-form-title');
    if (titleEl) titleEl.innerText = "Agregar Nuevo Producto";
}
